        ...
        <div id="main" class="w3-black">
            ...
            <div class="w3-right">
                ...
                <div class="w3-container">
                    <a href="./pgmEvent.jsp">
                        <input type="button" value="Add Programs" class="w3-button w3-purple" style="width: 50%; height: 40px">
                    </a><br><br>
                    <a href="./updateProgram.jsp">
                        <input type="button" value="Update Programs" class="w3-button w3-purple" style="width: 50%; height: 40px">
                    </a>
                </div>
                </center>
            </div>
