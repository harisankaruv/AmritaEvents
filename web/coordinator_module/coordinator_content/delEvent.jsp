...
<html>
    ...
    <body onload="gainfocus()">
        <%
            ...
            String eid=request.getParameter("subDel");
            try{
        %>
        ...
        <div id="main" class="w3-container w3-black">
            ...
            <div class="w3-card w3-white w3-padding-32" style="margin-top: 5%; height: 100%; ">
                ...
                <div class="w3-container" style="width: 50%">
                    <form method="post" action="delFinal.jsp">
                        <label for="">Delete</label>
                        <input type="text" value="<%=eid%>" placeholder="" style="width: 50%" class="w3-input w3-disabled w3-hover-gray w3-center" name="delete_id"/>
                        <br>
                        <input type="submit" value="Confirm?">
                    </form>
                            <a href="./eventView.jsp">Go back...</a>
                </div>
                </center>
            </div>
