                ...
                <div class="w3-container" style="width: 50%">
                    <%
                        ...
                        try{
                            ...
                            String query = "select * from program_details";
                    ...
                    %>
                        ...
                        <form method="post" action="upProgram.jsp">
                            <td>
                                <input type="submit" value="<%=rs.getInt(1)%>" name="progUp" class="w3-button w3-blue w3-text-blue w3-hover-blue w3-hover-text-blue" style="width: 100px">
                            </td>
                        </form>
                        </tr>
                    <%
