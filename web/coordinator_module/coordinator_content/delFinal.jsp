...
<html>
    ...
    <body onload="gainfocus()">
        <%
            ...
            int eveId=Integer.parseInt(request.getParameter("delete_id"));
            String sql="delete from event_details where event_id="+eveId+"";
        ...
        <div id="main" class="w3-container w3-black">
            ...
            <div class="w3-card w3-white w3-padding-32" style="margin-top: 5%; height: 100%; ">
                ...
                <div class="w3-container" style="width: 50%">
                    ...
                    %>
                    <span class="w3-text-gray">Event successfully removed!</span>
                    <%
