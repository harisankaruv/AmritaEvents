...
<html>
    ...
    <body>
        ...
        %>
        <div id="main">
            <span style="font-size:30px;cursor:pointer;font-family: Calibri" onclick="openNav()">&#9776; Amrita <b>Events</b>|Present Events</span>s
                        ...
                        <div class="w3-container">
                            ...
                            <div class="w3-card-4" style="width:70%">
                                ...
                                <form action="event_details/index.jsp">
                                    <input type="submit" value="<%=prsnt.getInt(1)%>" class="w3-button w3-hover-dark-grey w3-hover-text-dark-grey w3-block w3-text-dark-grey w3-dark-grey">
                                </form>
                            </div>
                        </div>
                    <%
