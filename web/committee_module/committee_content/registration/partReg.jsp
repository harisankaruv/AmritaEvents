            ...
            <div class="w3-card w3-white w3-padding-32" style="margin-top: 5%; height: 100%; ">
                ...
                <div class="w3-container" style="width: 50%">
                    ...
                    %>
                        ...
                        <form method="post" action="regPart.jsp">
                            <td>
                                <input type="submit" value="<%=rs.getInt(1)%>" name="programId" class="w3-button w3-green w3-text-green w3-hover-green w3-hover-text-green" style="width: 100px">
                            </td>
                        </form>
                        </tr>
                    <%
